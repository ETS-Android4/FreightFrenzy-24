...
public class PhoebeRoadRunnerDrive extends MecanumDrive {
    ...
    public static final TrajectoryAccelerationConstraint accelerationConstraint = new ProfileAccelerationConstraint(50);
    public static final  TrajectoryVelocityConstraint slowVelocityConstraint = new MinVelocityConstraint(Arrays.asList(
            new AngularVelocityConstraint(20),
    ...
    public PhoebeRoadRunnerDrive(HardwareMap hardwareMap) {
